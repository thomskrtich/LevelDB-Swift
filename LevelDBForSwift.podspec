#
#  Be sure to run `pod spec lint LevelDBForSwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "binjing" => "binjingbbk@163.com" }
  # Or just: s.author    = "binjing"
  # s.authors            = { "binjing" => "jing.bin@dosomi.com" }
  # s.social_media_url   = "http://twitter.com/binjing"
